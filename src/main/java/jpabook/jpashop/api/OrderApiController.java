...
public class OrderApiController {
    ...
    // 엔티티를 직접 노출하기 떄문에 좋은 코드가 아니다 -> DTO로 변환시켜 엔티티를 가려야한다.
    ...
    static class OrderDto {
        ...
        private List<OrderItemDto> orderItems; // OrderITem도 의존성을 끊어야하기 때문에 이것도 DTO로 변환을 시켜야한다.
                                            // orderItems의 이름을 바꾸게 되면 전체 api의 영향을 주기 때문이다.
